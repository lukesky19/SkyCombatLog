 ...
 * @param flightDisabled The message sent when a player has their flight disabled while in combat.
 * @param flightNotAllowed The message sent when a player tries to enable flight while in combat.
...
public record Locale(
        ...
        String flightNotAllowed,
        String actionBar,
        TimeMessage timeMessage) {
    /**
     * This record contains the configuration for a {@literal <time>} placeholder.
